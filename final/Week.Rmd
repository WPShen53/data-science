...
Not surprisingly, we found similarities and differences of most used words in the social medias. Next, we will exam the word collections using the `collocations` function. It is handy function that returns a data.frame of collocations and their scores, in descending order of the association measure.
