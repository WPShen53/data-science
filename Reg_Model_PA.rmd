...
A quick exam of the dataset has found the variables cyl, vs, am, gear and carb are factors. Thus, a type conversion was down first.   

```{r}
dt$cyl <- factor(dt$cyl)
dt$vs <- factor(dt$vs)
dt$am <- factor(dt$am, labels = c("automatic","manual"))
